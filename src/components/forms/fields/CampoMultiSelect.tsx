          ...
          <div key={opcao} className="flex items-center">
            <button
              ...
              className={`px-2.5 py-1 text-xs font-medium border transition-colors ${
                ...
                activo
                  ...
                  : 'bg-white dark:bg-slate-800 text-slate-700 dark:text-slate-300 border-slate-300 dark:border-slate-600 hover:border-gold hover:text-gold'
              }`}
            >
              {opcao}
            </button>
            ...
            {temQtd && activo && (
              <input
                ...
                className="w-10 text-center text-xs border border-l-0 border-gold rounded-r py-1 text-slate-900 dark:text-slate-100 focus:outline-none focus:ring-1 focus:ring-gold bg-white dark:bg-slate-700"
              />
            )}
          </div>
        )
