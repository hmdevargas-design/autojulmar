  ...
  return (
    <div className="relative">
      <input
        ...
        className="w-full border border-slate-700 rounded-lg px-3 py-2 text-sm font-mono uppercase text-slate-100 bg-slate-800 placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-gold"
